...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-12/23-51-39_random_30_30_rsi/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-12/23-51-39_random_30_30_rsi/best_model.zip"  # "trained_models/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_random_25_25_rsi"
