...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-28/23-43-08_20_06pi_full-physics_score-on-same/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-28/23-43-08_20_06pi_full-physics_score-on-same/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_8_06pi_full-physics"
