...
PATH_TO_NORMALIZED_ENV = (
    "output/training/2022-10-30/00-24-38_8_06pi_full-physics_finished/training_env.pkl"
)

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = (
    "output/training/2022-10-30/00-24-38_8_06pi_full-physics_finished/best_model.zip"
)
