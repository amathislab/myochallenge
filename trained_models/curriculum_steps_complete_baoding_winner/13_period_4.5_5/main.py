...
PATH_TO_NORMALIZED_ENV = "trained_models/random/11-52-46_random_5_5/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "trained_models/random/11-52-46_random_5_5/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_random_4.5_5"
...
config = {
    ...
    "noise_fingers": 0,
    "noise_balls": 0,
    "goal_time_period": [4.5, 5],   # phase 2: (4, 6)
