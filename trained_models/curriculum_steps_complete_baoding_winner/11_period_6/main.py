...
PATH_TO_NORMALIZED_ENV = "trained_models/random/11-35-27_random_7_7/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "trained_models/random/11-35-27_random_7_7/best_model.zip"
