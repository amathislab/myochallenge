...
PATH_TO_NORMALIZED_ENV = "trained_models/baoding_phase2/00-45-16_final_nisheet_score-36/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "trained_models/baoding_phase2/00-45-16_final_nisheet_score-36/best_model.zip"  # "trained_models/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_nisheet_36_new_hp_larger_rate"
...
if __name__ == "__main__":
    ...
    checkpoint_callback = CheckpointCallback(
        save_freq=5000, save_path=TENSORBOARD_LOG, save_vecnormalize=True
    )
