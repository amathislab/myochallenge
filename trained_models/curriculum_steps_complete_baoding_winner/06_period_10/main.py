...
PATH_TO_NORMALIZED_ENV = (
    "output/training/2022-10-14/10-16-16_random_15_15_rsi_prob_0_9/final_env.pkl"
)

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = (
    "output/training/2022-10-14/10-16-16_random_15_15_rsi_prob_0_9/final_model.pkl"
)
