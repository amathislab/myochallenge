...
PATH_TO_NORMALIZED_ENV = "output/training/2022-11-01/13-22-37_nisheet_36_new_hp_pos_dist_10/rl_model_vecnormalize_5120000_steps.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-11-01/13-22-37_nisheet_36_new_hp_pos_dist_10/rl_model_5120000_steps.zip"  # "trained_models/best_model.zip"
