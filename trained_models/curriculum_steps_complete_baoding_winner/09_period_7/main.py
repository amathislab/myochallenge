...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-15/23-16-20_random_8_8/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-15/23-16-20_random_8_8/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_random_7_7"
...
config = {
    ...
    "noise_fingers": 0,
    "noise_balls": 0,
    "goal_time_period": [7, 7],   # phase 2: (4, 6)
