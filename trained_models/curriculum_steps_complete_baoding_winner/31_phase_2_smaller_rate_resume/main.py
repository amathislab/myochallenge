...
PATH_TO_NORMALIZED_ENV = "output/training/2022-11-01/17-51-32_nisheet_36_new_hp_pos_dist_10_alive_1_solved_5/rl_model_vecnormalize_32320000_steps.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-11-01/17-51-32_nisheet_36_new_hp_pos_dist_10_alive_1_solved_5/rl_model_32320000_steps.zip"  # "trained_models/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = (
    datetime.now().strftime("%Y-%m-%d/%H-%M-%S")
    + "_nisheet_36_new_hp_pos_dist_5_alive_1_solved_5"
)
