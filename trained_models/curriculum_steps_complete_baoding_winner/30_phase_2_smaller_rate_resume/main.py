...
PATH_TO_NORMALIZED_ENV = "output/training/2022-11-01/17-02-41_nisheet_36_new_hp_pos_dist_10/rl_model_vecnormalize_960000_steps.pkl"  # "trained_models/normalized_env_original"
...
if __name__ == "__main__":
    ...
    score_callback = EvaluateLSTM(
        eval_freq=20000, eval_env=env_score, name="eval/score", num_episodes=20
    )
