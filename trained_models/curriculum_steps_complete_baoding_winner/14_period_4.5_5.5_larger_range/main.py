...
from metrics.callbacks import EnvDumpCallback

env_name = "CustomMyoBaodingBallsP1"

# saving criteria
saving_criteria = "dense_rewards"  # score, dense_rewards
...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-20/22-46-40_random_4.5_5/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-20/22-46-40_random_4.5_5/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_random_4.5_5.5_larger_range"
