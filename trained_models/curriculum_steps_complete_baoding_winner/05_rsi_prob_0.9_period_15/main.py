...
PATH_TO_NORMALIZED_ENV = (
    "output/training/2022-10-13/20-21-46_random_20_20_rsi_prob_0_9/training_env.pkl"
)

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = (
    "output/training/2022-10-13/20-21-46_random_20_20_rsi_prob_0_9/best_model.zip"
)
