...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-27/08-26-34_period_20_angle_0_6pi/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-27/08-26-34_period_20_angle_0_6pi/best_model.zip"  # "trained_models/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_period_20_angle_0_8pi"
...
if __name__ == "__main__":
    ...
    effort_callback = EvaluateLSTM(
        eval_freq=20000, eval_env=env_effort, name="eval/effort", num_episodes=10
    )
