...
PATH_TO_NORMALIZED_ENV = "output/training/2022-11-03/08-54-24_nisheet_36_new_hp_pos_dist_5_alive_1_solved_5_resume/rl_model_vecnormalize_19040000_steps.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-11-03/08-54-24_nisheet_36_new_hp_pos_dist_5_alive_1_solved_5_resume/rl_model_19040000_steps.zip"  # "trained_models/best_model.zip"
