...
PATH_TO_NORMALIZED_ENV = "trained_models/final_pablo/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "trained_models/final_pablo/best_model.zip"  # "trained_models/best_model.zip"
