...
PATH_TO_NORMALIZED_ENV = "output/training/2022-11-01/12-01-25/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-11-01/12-01-25/best_model.zip"  # "trained_models/best_model.zip"
...
if __name__ == "__main__":
    ...
    model.learn(
        total_timesteps=30_000_000, callback=[checkpoint_callback,eval_callback,effort_callback], reset_num_timesteps=True
    )
