...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-31/15-23-15/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-31/15-23-15/best_model.zip"  # "trained_models/best_model.zip"
