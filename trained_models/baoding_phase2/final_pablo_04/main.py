...
PATH_TO_NORMALIZED_ENV = "trained_models/00-45-16_final_nisheet_score-36/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "trained_models/00-45-16_final_nisheet_score-36/best_model.zip"  # "trained_models/best_model.zip"
...
if __name__ == "__main__":
    ...
    config_effort = copy.deepcopy(config)
