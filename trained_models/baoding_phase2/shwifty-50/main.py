...
if __name__ == "__main__":
    ...
    score_callback = EvaluateLSTM(
        eval_freq=2_000_000, eval_env=env_score, name="eval/score", num_episodes=50
    )
    ...
    checkpoint_callback = CheckpointCallback(
        save_freq=1_000_000, save_path=TENSORBOARD_LOG, save_vecnormalize=True
    )
    ...
    if FIRST_TASK:
        ...
        custom_objects = {
            "lr_schedule": lambda _: 1e-04,
            "learning_rate": lambda _: 1e-04,
            "clip_range": 0.2,
            "n_steps": 1024*16,
            "batch_size": 1024*16,
            "ent_coef": 0.0,
