...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-26/08-59-44/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-26/08-59-44/best_model.zip"  # "trained_models/best_model.zip"
