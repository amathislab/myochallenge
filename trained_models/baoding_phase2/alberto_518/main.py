...
PATH_TO_NORMALIZED_ENV = "trained_models/baoding_phase2/final_pablo/training_env.pkl"
PATH_TO_PRETRAINED_NET = "trained_models/baoding_phase2/final_pablo/best_model.zip"
# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_from_pablo_final_5_dist_5_solved"
