...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-30/00-24-38_period-8_06pi_full-physics_score-45-on-same-20-on-final-task/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-30/00-24-38_period-8_06pi_full-physics_score-45-on-same-20-on-final-task/best_model.zip"  # "trained_models/best_model.zip"
...
if __name__ == "__main__":
    ...
    score_callback = EvaluateLSTM(eval_freq = 50000, eval_env = env_score, name = 'eval/score', num_episodes=10)
    effort_callback = EvaluateLSTM(eval_freq = 50000, eval_env = env_effort, name = 'eval/effort', num_episodes=10)
