...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-25/09-46-45_4.5_5.5_random_tiny_angle/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-25/09-46-45_4.5_5.5_random_tiny_angle/best_model.zip"  # "trained_models/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_p2_random_period_inf_noisy"
...
config = {
    ...
    'obj_size_range': (0.020, 0.023),    #(0.018, 0.024   # Object size range. Nominal 0.022
    'obj_mass_range': (0.040, 0.1),    #(0.030, 0.300)   # Object weight range. Nominal 43 gms
    'obj_friction_change': (0.02, 0.0001, 0.000002), # (0.2, 0.001, 0.00002) nominal: 1.0, 0.005, 0.0001
    'task_choice': 'random'
}
