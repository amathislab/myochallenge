...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-20/10-09-43/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-20/10-09-43/best_model.zip"  # "trained_models/best_model.zip"
...
config = {
    ...
    "enable_rsi": False,
    "rsi_probability": 0,
    # "rsi_distance_pos":0.5,
    # "rsi_distance_rot":0.5,
    # "rsi_random_point":True
}
