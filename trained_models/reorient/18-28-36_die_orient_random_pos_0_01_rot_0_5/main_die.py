...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-12/11-54-08_die_orient_random_pos_0_01_rot_0_3/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-12/11-54-08_die_orient_random_pos_0_01_rot_0_3/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = (
    datetime.now().strftime("%Y-%m-%d/%H-%M-%S")
    + "_die_orient_random_pos_0_01_rot_0_5"
)
