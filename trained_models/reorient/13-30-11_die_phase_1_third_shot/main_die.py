...
PATH_TO_NORMALIZED_ENV = "trained_models/reorient/16-33-51_die_orient_phase_1/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = (
    "trained_models/reorient/16-33-51_die_orient_phase_1/best_model.zip"
)
...
config = {
    ...
    # "rsi_distance_rot": 0,
    # "goal_rot_x": [(0, 0)],
    # "goal_rot_y": [(-1.57/2, -1.57/2), (1.57/2, 1.57/2)],
    # "goal_rot_z": [(0, 0)],
