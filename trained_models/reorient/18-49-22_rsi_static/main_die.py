...
PATH_TO_NORMALIZED_ENV = "trained_models/reorient/19-10-08_die_orient_random_pos_0_003_rot_0_1/training_env.pkl"  # "trained_models/normalized_env_original"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "trained_models/reorient/19-10-08_die_orient_random_pos_0_003_rot_0_1/best_model.zip"  # "trained_models/best_model.zip"
