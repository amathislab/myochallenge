...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-15/12-02-09_random_10_10_rsi_prob_0_9/training_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-15/12-02-09_random_10_10_rsi_prob_0_9/best_model.zip"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_random_9_9"
...
config = {
    ...
    "noise_fingers": 0,
    "noise_balls": 0,
    "goal_time_period": [9, 9],   # phase 2: (4, 6)
