...
PATH_TO_NORMALIZED_ENV = "output/training/2022-10-14/10-16-16_random_15_15_rsi_prob_0_9/final_env.pkl"

# Path to pretrained network (if not first task)
PATH_TO_PRETRAINED_NET = "output/training/2022-10-14/10-16-16_random_15_15_rsi_prob_0_9/final_model.pkl"

# Tensorboard log (will save best model during evaluation)
now = datetime.now().strftime("%Y-%m-%d/%H-%M-%S") + "_random_10_10_rsi_prob_0_9"
...
config = {
    ...
    "noise_fingers": 0,
    "noise_balls": 0,
    "goal_time_period": [10, 10],   # phase 2: (4, 6)
