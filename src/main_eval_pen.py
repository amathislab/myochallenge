...
PATH_TO_NORMALIZED_ENV = os.path.join(ROOT_DIR, "output/training/2023-01-06/11-55-33_pen_twirl_random_static_full_range/rl_model_vecnormalize_2400000_steps.pkl")
PATH_TO_PRETRAINED_NET = os.path.join(ROOT_DIR, "output/training/2023-01-06/11-55-33_pen_twirl_random_static_full_range/rl_model_2400000_steps.zip")
